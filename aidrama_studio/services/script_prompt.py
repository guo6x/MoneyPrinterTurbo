...
import json
from aidrama_studio.domain import Project, ScriptBeatType, StoryBible


_SCRIPT_BEAT_TYPE_VALUES = [item.value for item in ScriptBeatType]
_SCRIPT_BEAT_TYPE_SCHEMA = json.dumps(_SCRIPT_BEAT_TYPE_VALUES, ensure_ascii=False)
